...
from tasks import CurriculumTasks,jdTasks
from agents import Agents,jdAgent
...
def generate_jd(company_domain,hiring_needs,specific_benefits,company_description):
    try:
        tasks = jdTasks()
        agents = jdAgent()
        ...
        industry_analysis_task = tasks.industry_analysis_task(researcher_agent, company_domain)
        ...
        print("Starting jd Creation...")
        result = crew.kickoff()
        print("jd Creation complete")
